...
public class GetUserProfileService extends BaseService<GetUserProfileRequest, UserProfileResponse> {
    ...
    protected UserProfileResponse doProcess(GetUserProfileRequest request) {
        ...
        ProfileCountCacheService.ProfileCounts counts = profileCountCacheService.getCounts(targetId);
        long followersCount = counts.getFollowers();
        long followingCount = counts.getFollowing();
        long postsCount = counts.getPosts();
