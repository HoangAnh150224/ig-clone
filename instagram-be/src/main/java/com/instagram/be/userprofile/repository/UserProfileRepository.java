...
public interface UserProfileRepository extends JpaRepository<UserProfile, UUID> {
    ...
    @Query("SELECT u FROM UserProfile u WHERE LOWER(u.username) LIKE LOWER(CONCAT(:q, '%')) OR LOWER(u.fullName) LIKE LOWER(CONCAT('%', :q, '%')) ORDER BY u.verified DESC, u.username ASC")
