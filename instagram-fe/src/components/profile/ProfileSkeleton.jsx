...
import { 
  Box, Flex, VStack, HStack, Skeleton, SkeletonCircle, Container, Grid, GridItem 
    ...
    <Container maxW="935px" p={0} bg="white">
      ...
      <Flex direction={{ base: "column", md: "row" }} gap={{ base: 8, md: 20 }} py={8} px={4} align="center">
        ...
        <VStack align="start" gap={6} flex={1}>
          ...
          <HStack gap={10} display={{ base: "none", md: "flex" }} width="100%">
      ...
      <HStack gap={10} px={10} py={4} mb={10} overflowX="hidden">
        {[1, 2, 3, 4].map((i) => (
          <VStack key={i} gap={2}>
            <SkeletonCircle size="87px" p="3px" border="1px solid" borderColor="gray.100" />
      ...
      {/* Tabs Skeleton */}
      <Flex borderTop="1px solid" borderColor="gray.200" justify="center" gap={16}>
