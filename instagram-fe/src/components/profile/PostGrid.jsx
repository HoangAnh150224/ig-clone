...
import { SimpleGrid, Box, Image, Flex, HStack, Text, Icon } from '@chakra-ui/react';
...
const PostGridItem = ({ post, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {/* Reel Icon Indicator */}
      {isReel && (
        <Box position="absolute" top={3} right={3} color="white" zIndex={5} filter="drop-shadow(0 0 2px rgba(0,0,0,0.5))">
