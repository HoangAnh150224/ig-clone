...
import { 
  ...
  AiFillPlusSquare, AiOutlinePlusSquare, 
  AiOutlineMenu, 
...
const SidebarItem = ({ icon: OutlineIcon, activeIcon: FillIcon, label, active, avatar, onClick, isExpanded }) => {
        ...
        {showMoreMenu && (
          <Box position="absolute" bottom="70px" left="12px" width="220px" bg="white" borderRadius="16px" boxShadow="0 4px 24px rgba(0,0,0,0.15)" p={2} zIndex={110}>
            <VStack align="stretch" gap={0}>
              ...
              <HStack p={3} borderRadius="8px" _hover={{ bg: "gray.50" }} cursor="pointer" onClick={() => handleNavigate('/archive/stories')}>
