...
import { AiOutlineClose, AiOutlineArrowLeft, AiOutlineTags } from "react-icons/ai";
...
const CreatePostModal = () => {
    ...
    const handleShare = async () => {
        ...
        setLoading(true);
        try {
            const uploadRes = await cloudinaryService.upload(selectedFile, postType.toLowerCase());
            ...
            if (postType === "STORY") {
                ...
                const finalType = postType === "REEL" || uploadRes.mediaType === "VIDEO" ? "REEL" : "POST";
            ...
            >
                ...
                >
                    ...
                    <Text fontWeight="bold" color="black">
                        {previewUrl ? `Create new ${postType.toLowerCase()}` : `Create new ${postType.toLowerCase()}`}
                    </Text>
                    ...
                    {!previewUrl ? (
                        <Center flex={1} flexDirection="column" gap={4}>
                            ...
                            <Text fontSize="xl" color="gray.600">
                                Drag {postType === "REEL" ? "video" : "photos and videos"} here
                            </Text>
                            <input
                                type="file"
                            ...
                            <VStack gap={4} mt={4}>
                                <HStack gap={4}>
                                    ...
                                    <Button 
                                        size="sm" 
                                        variant={postType === "REEL" ? "solid" : "outline"}
                                        bg={postType === "REEL" ? "black" : "transparent"}
                                        color={postType === "REEL" ? "white" : "black"}
                        ...
                        >
                            ...
                            >
                                <Box p={4}>
                                    ...
                                    <Box mb={6}>
                                        <Text fontSize="xs" fontWeight="bold" color="gray.500" mb={2} textTransform="uppercase">Share as:</Text>
                                        <HStack gap={4}>
                                            <Button 
                                                size="sm" 
                                                variant={postType === "POST" ? "solid" : "outline"}
                                    ...
                                    <Box as="textarea"
                                        placeholder={postType === "POST" ? "Write a caption..." : postType === "REEL" ? "Write a caption for your reel..." : "Add text to story (optional)..."}
                                        style={{
                                            width: "100%",
                                            height: "120px",
                                            fontSize: "16px",
                                    ...
                                    <Flex justify="space-between" color="gray.400" mb={4}>
                                    ...
                                    {(postType === "POST" || postType === "REEL") && (
                                        <VStack align="stretch" gap={0} borderTop="1px solid" borderColor="gray.100">
                                            <Flex align="center" py={3} borderBottom="1px solid" borderColor="gray.100">
                                                <Box color="black" mr={3}>
                                                    <GrLocation size={20} />
                                                </Box>
                                                <Box as="input"
                                                    placeholder="Add location" 
                                                    style={{ border: "none", outline: "none", fontSize: "14px", color: "black", width: "100%" }}
                                                    value={locationName}
                                            ...
                                            <Box>
                                                ...
                                                >
                                                    <HStack color="black" fontWeight="600" fontSize="sm">
                                                        <Box mr={2}><BsGear size={18} /></Box>
                                                        <Text>Advanced Settings</Text>
                                                    </HStack>
                                                    {isAdvancedSettingsOpen ? <BsChevronUp size={14} color="black" /> : <BsChevronDown size={14} color="black" />}
                                                </Flex>

                                                {isAdvancedSettingsOpen && (
                                                    <VStack align="stretch" gap={4} pb={4}>
                                                        <Flex justify="space-between" align="center">
                                                            <Text fontSize="sm" color="black">Hide like and view counts</Text>
                                                            <input 
                                                                type="checkbox"
                                                        ...
                                                        <Text fontSize="xs" color="gray.500">Only you will see the total number of likes and views on this post. You can change this later.</Text>
                                                        
                                                        <Flex justify="space-between" align="center" mt={2}>
                                                            <Text fontSize="sm" color="black">Turn off commenting</Text>
                                                            <input 
                                                                type="checkbox"
                                                        ...
                                                        <Text fontSize="xs" color="gray.500">You can change this later from the menu at the top of your post.</Text>
                                                    </VStack>
                                                )}
                                            </Box>
                                        </VStack>
                                        ...
                                        <Box py={4} borderTop="1px solid" borderColor="gray.100">
                                            <Flex justify="space-between" align="center">
                                                <VStack align="start" gap={0}>
                                                    ...
                                                    <Text fontSize="xs" color="gray.500">Only people in your close friends list can see this.</Text>
                                                </VStack>
                                                <input 
                                                    type="checkbox"
